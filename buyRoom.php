...
function createStudent()
{
	...
	//$query="UPDATE `Klabu`.`ProfilePictures` SET `id` =$id,`url` = '$grade' WHERE `student_details`.`Admission_No` = $Admission_No;";
	$query="INSERT INTO `products` (`ProductId`,`id`, `ProductImageUrl`, `ProductType`, `ProductMake`, `ProductColour`, `Price`, `OtherDescriptions`, `ActualImage`, `UploadTime`) VALUES (NULL, '$id', 'http://www.zebaki.co.ke/Klabu/AdminUploads/58c44593bd4ad.png', '$HostelName', 'Hostel room', 'I would like to buy a room', '$Price', '$OtherDescriptions', '58c44593bd4ad',NOW())"; 
